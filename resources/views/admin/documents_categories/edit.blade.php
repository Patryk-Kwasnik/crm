        ...
        <div class="row">
            <div class="col-lg-12 margin-tb">
                ...
                <div class="pull-right p-4">
                    <a class="btn btn-primary" href="{{ route('admin.documents_categories.index') }}"> {{ __('system.back') }}</a>
                </div>
            </div>
        </div>
        <x-alert-error :errors="$errors" />
        <form method="POST" action="{{ route('admin.documents_categories.update', $category->id) }}">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-5">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" placeholder="Category Name" class="form-control" value="{{ old('name') ?? $category->name }}">
                ...
                <div class="col-xs-12 col-sm-12 col-md-5">
                    <div class="form-group">
                        ...
                        <input type="text" name="slug" placeholder="slug" class="form-control"  value="{{ old('slug') ?? $category->slug }}" >
                    </div>
                </div>
                <div class="col-xs-12 col-sm-12 col-md-5">
                    <div class="form-group">
